...
class EditFoodTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    @IBAction func done(_ sender: Any) {
        ...
        if nameTextField.text!.characters.count  == 0 || addressTextField.text!.characters.count == 0 || phoneTextField.text!.characters.count == 0 {
            
            let controller = UIAlertController(title: "欄位不可空白", message: nil, preferredStyle: .alert)
