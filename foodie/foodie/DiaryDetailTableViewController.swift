    ...
    */
    ...
    @IBAction func doneButton(_ sender: Any) {
        if nameTextField.text?.count == 0 {
            let alertController = UIAlertController(title: "請輸入餐廳", message: nil, preferredStyle: .alert)
        ...
        performSegue(withIdentifier: "goBackToDiaryTableWithSegue", sender: nil)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if diary == nil {
            diary = Diary(name: nameTextField.text!, content: contentTextView.text!)
        } else {
